...
import { TTeamMember } from "@/src/store/types/team";
...
export default function MemberCard({
  ...
  return (
    <div className="rounded-lg border border-[rgba(204,212,216,1)] p-2 px-3">
      ...
      <div>
        <p className="mb-1 text-sm font-bold lg:text-base">{fullName}</p>
        ...
        <div className="flex items-center justify-between space-x-1.5 border-t-[0.5px] border-t-black/20 pt-2">
          <div className="flex items-center space-x-1">
            ...
            <span className="text-xs">{format(createdAt, "dd MMM, yyyy")}</span>
          </div>
